<?php 
  ...
  if(isset($_POST['signup'])){
    ...
    $check = mysqli_query($con, "SELECT * FROM admins WHERE username = '$uname'");
    if(mysqli_num_rows($check) > 0){
      echo 'Username already exists';
    } else {
      $signup = mysqli_query($con, "INSERT INTO admins VALUES('', '$name', '$uname', '$pw', 'avatar.jpg')");
      if($signup){
        header('location: ./');
      }
...
<body>
<div class="form-page">
    <h1>Signup to <span>MeetMe Dating App</span> Dashboard</h1>
    <div class="form">
      <div class="logo">
